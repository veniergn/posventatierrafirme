...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9FB] flex flex-col font-sans selection:bg-[#FFDAD5] selection:text-[#8A1B17]">
      ...
      {isOffline && (
        <div className="fixed inset-0 z-[9999] bg-black/80 backdrop-blur-sm flex flex-col items-center justify-center p-6 text-center animate-in fade-in">
          <div className="bg-white p-8 rounded-2xl shadow-2xl max-w-sm w-full space-y-4">
            ...
            <h2 className="text-xl font-bold text-gray-900">Sin Conexión</h2>
            <p className="text-sm text-gray-600">
              Esta aplicación requiere internet para sincronizar los datos. No se pueden realizar cambios sin conexión.
            </p>
          </div>
        </div>
      )}
